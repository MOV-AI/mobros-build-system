...
class InstallBuildDependsExecutor:
    ...
    def execute(self, args):
        ...
        if os.getuid() != 0 and not args.simulate:
          logging.error("This command requires sudo to be able to install the dependencies. If you just want to simulate, use --simulate")
          sys.exit(1)
        ...
        for install_elem in install_list:
          if "version" in install_elem:
            install_package(install_elem["name"], install_elem["version"], simulate=args.simulate)
          else:
