import unittest
import mock
from MovaiRosBuildSystem.utils.utilitary import execute_shell_command, execute_bash_script
from MovaiRosBuildSystem.constants import TEST_RESOURCE_SHELL_SCRIPT
