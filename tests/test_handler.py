...
class TestHandler(unittest.TestCase):
    ...
    @mock.patch('MovaiRosBuildSystem.ros_pack.pack_executor.RosPackExecutor.execute')
    @mock.patch('MovaiRosBuildSystem.ros_build.build_executor.RosBuildExecutor.execute')
    ...
    @mock.patch('MovaiRosBuildSystem.ros_pack.pack_executor.RosPackExecutor.add_expected_arguments', side_effect=mock_add_expected_arguments)
    @mock.patch('MovaiRosBuildSystem.ros_build.build_executor.RosBuildExecutor.execute')
