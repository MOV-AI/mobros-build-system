...
class TestHandler(unittest.TestCase):
    ...
    @mock.patch(
        "argparse.ArgumentParser.parse_known_args", return_value=[argeparse_executor_build,None]
    )
    ...
    @mock.patch("mobros.commands.ros_build.build_executer.RosBuildExecuter.execute")
    @mock.patch(
        "argparse.ArgumentParser.parse_known_args", return_value=[argeparse_executor_pack, None]
    )
